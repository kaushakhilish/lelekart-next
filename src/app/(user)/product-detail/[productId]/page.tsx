    ...
    <div className="flex-col justify-start items-center w-full px-8 font-urbanist" >
        ...
        <div className="w-full flex justify-between">
            <div className="w-[50%] flex flex-col gap-4 items-center justify-start">
                ...
                <PincodeForm/>
                <div className="w-[80%] font-bold text-xl pt-2">Features</div>
            ...
            <div className="w-[45%]">
                    ...
                    <div className="flex gap-2 py-4">
                        ...
                        <Button variant="outline" className="rounded-full px-8 font-bold border-2 border-black flex gap-2 items-center"  ><Heart size={20}/>ADD TO WISHLIST</Button>
                    </div>
